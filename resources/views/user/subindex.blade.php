...
<script src="{{url('js/locationpicker.js')}}"></script>
  ...
  <script type="text/javascript" src="{{ URL::to('js/code.js') }}?v=2132132"></script>

  <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js'></script>
   <script type="text/javascript" src="{{ URL::to('demo/button.js').'?version=1'}}"></script>
   <script src="{{ URL::to('demo/script.js').'?version=133' }}"></script>
