...
<script type="text/javascript" src="{{ URL::to('js/code.js').'?version=965326' }}"></script>


<script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js'></script>
<script type="text/javascript" src="{{ URL::to('demo/button.js')}}"></script>
<script src="{{ URL::to('demo/script.js')}}"></script>
